/* abdavdirectoryfactory.js - This file is part of "SOGo Connector", a Thunderbird extension.
 *
...
AbDAVDirFactory.prototype = {
    createDirectory: function(properties) {
        ...
        try {
            ...
            var directory = rdf.GetResource("moz-abdavdirectory://" + properties.prefName)
