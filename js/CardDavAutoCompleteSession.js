	...
	if ( !listener ) {
		...
		if ( url ){			
			...
			if (nodeList.length > 0){
				...
				var results = Components.classes["@mozilla.org/autocomplete/results;1"].createInstance(Components.interfaces.nsIAutoCompleteResults);
...
function formatAutoCompleteItem( card, searchString ){
	var item = Components.classes["@mozilla.org/autocomplete/item;1"].createInstance(Components.interfaces.nsIAutoCompleteItem);
